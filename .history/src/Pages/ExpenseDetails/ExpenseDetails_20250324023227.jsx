// src/components/ExpenseDetails/ExpenseDetails.jsx
import React, { useState } from 'react';
import '../../Styles/ExpenseDetails.scss';
import * as XLSX from 'xlsx';

const ExpenseDetails = ({ expenses = [], setExpenses }) => { // Default to empty array
  ...
  const importFromExcel = (e) => {
    ...
    reader.onload = (event) => {
      ...
      setExpenses(importedData); // Update expenses dynamically
    };
